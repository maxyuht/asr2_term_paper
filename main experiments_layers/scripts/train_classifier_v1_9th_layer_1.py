...
if __name__ == "__main__":
    # ✅ 数据加载
    train_set = FeatureEmotionDataset("./splits_v1_9th_layer_1/train")
    val_set = FeatureEmotionDataset("./splits_v1_9th_layer_1/val")
    ...
    os.makedirs("./models_v1_9th_layer_1", exist_ok=True)
    log_file = open("train_log_v1_9th_layer_1.txt", "w")
    ...
    for epoch in range(30):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "./models_v1_9th_layer_1/best_model_v1_9th_layer_1.pt")
    ...
    log_file.close()
    torch.save(model.state_dict(), "./models_v1_9th_layer_1/classifier_v1_9th_layer_1.pt")
    ...
    plt.tight_layout()
    plt.savefig("training_curve_v1_9th_layer_1.png")
    plt.show()
    ...
    with open("val_classification_report_v1_9th_layer_1.txt", "w") as f:
    ...
    plt.grid(False)
    plt.savefig("val_confusion_matrix_v1_9th_layer_1.png")
    plt.show()
