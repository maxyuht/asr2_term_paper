# scripts/split_dataset_v1_6th_layer_1.py
...
# ✅ 设置路径
features_dir = "./features_v1_6th_layer_1"
splits_dir = "./splits_v1_6th_layer_1"
...
print("Reading 6th-layer features...")
...
print("\n✅ Split result for 6th-layer features:")
print(df)

# ✅ 保存统计
df.to_csv("split_stats_v1_6th_layer_1.csv")
