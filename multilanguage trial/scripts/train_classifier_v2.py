...
if __name__ == "__main__":
    # ✅ 数据加载
    train_set = FeatureEmotionDataset("./splits_v2/train")
    val_set = FeatureEmotionDataset("./splits_v2/val")
    ...
    log_file = open("train_log_v2.txt", "w")
    ...
    for epoch in range(30):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "./models_v2/best_model_v2.pt")
    ...
    log_file.close()
    torch.save(model.state_dict(), "./models_v2/classifier_v2.pt")
    ...
    with open("val_classification_report_v2.txt", "w") as f:
    ...
    plt.grid(False)
    plt.savefig("val_confusion_matrix_v2.png")
    plt.show()
