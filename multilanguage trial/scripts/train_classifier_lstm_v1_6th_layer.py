...
if __name__ == "__main__":
    # ✅ 加载数据
    train_set = FeatureEmotionDataset("./splits_lstm_v1_6th_layer/train")
    val_set = FeatureEmotionDataset("./splits_lstm_v1_6th_layer/val")
    ...
    os.makedirs("./models_lstm_v1_6th_layer", exist_ok=True)
    log_file = open("train_log_lstm_v1_6th_layer.txt", "w")
    ...
    for epoch in range(30):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "./models_lstm_v1_6th_layer/best_model_lstm_v1_6th_layer.pt")
    ...
    log_file.close()
    torch.save(model.state_dict(), "./models_lstm_v1_6th_layer/classifier_lstm_v1_6th_layer.pt")
    ...
    plt.tight_layout()
    plt.savefig("training_curve_lstm_v1_6th_layer.png")
    plt.show()
    ...
    with open("val_classification_report_lstm_v1_6th_layer.txt", "w") as f:
    ...
    plt.grid(False)
    plt.savefig("val_confusion_matrix_lstm_v1_6th_layer.png")
    plt.show()
