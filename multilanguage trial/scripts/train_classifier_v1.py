...
if __name__ == "__main__":
    # ✅ 数据加载
    train_set = FeatureEmotionDataset("./splits_v1/train")
    val_set = FeatureEmotionDataset("./splits_v1/val")
    ...
    os.makedirs("./models_v1", exist_ok=True)
    ...
    for epoch in range(30):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "./models_v1/best_model_v1.pt")
    ...
    log_file.close()
    torch.save(model.state_dict(), "./models_v1/classifier_v1.pt")
    ...
    plt.tight_layout()
    plt.savefig("training_curve_v1.png")
    plt.show()
    ...
    with open("val_classification_report_v1.txt", "w") as f:
    ...
    plt.grid(False)
    plt.savefig("val_confusion_matrix_v1.png")
    plt.show()
