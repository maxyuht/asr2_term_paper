...
if __name__ == "__main__":
    # ✅ 数据加载
    train_set = FeatureEmotionDataset("./splits_v3/train")
    val_set = FeatureEmotionDataset("./splits_v3/val")
    ...
    log_file = open("train_log_v3.txt", "w")
    ...
    for epoch in range(30):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "./models_v3/best_model_v3.pt")
    ...
    log_file.close()
    torch.save(model.state_dict(), "./models_v3/classifier_v3.pt")
    ...
    plt.tight_layout()
    plt.savefig("training_curve_v3.png")
    plt.show()
    ...
    with open("val_classification_report_v3.txt", "w") as f:
    ...
    plt.grid(False)
    plt.savefig("val_confusion_matrix_v3.png")
    plt.show()
