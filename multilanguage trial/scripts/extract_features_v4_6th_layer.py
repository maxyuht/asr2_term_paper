...
#  路径设置
data_dir = "./data_v4"
save_dir = "./features_v4_6th_layer"
...
for emotion in os.listdir(data_dir):
    ...
    for wav in tqdm(file_list, desc=f"{emotion}", ncols=80):
        ...
        with torch.no_grad():
            ...
            hidden_states = outputs.hidden_states[6]  # ✅ 使用第 6 层
...
print(" All features have saved to ./features_v4_6th_layer/\n")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("tsne_visualization_v4_6th_layer.png")
plt.show()

print(" t-SNE saving as tsne_visualization_v4_6th_layer.png ")
