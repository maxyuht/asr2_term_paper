...
# ✅ 路径设置
data_dir = "./data_v1"
save_dir = "./features_v1_3th_layer_1"
...
print("HuBERT is extracting 3th-layer features for attention pooling...\n")
for emotion in os.listdir(data_dir):
    ...
    for wav in tqdm(file_list, desc=f"{emotion}", ncols=80):
        ...
        with torch.no_grad():
            ...
            hidden_states = outputs.hidden_states[3]  # 第3层
...
print("✅ All 3th-layer features saved to ./features_v1_3th_layer_1/\n")
...
plt.title("t-SNE of HuBERT 3th-Layer Features")
plt.xlabel("Dim 1")
plt.ylabel("Dim 2")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("tsne_visualization_v1_3th_layer_1.png")
plt.show()

print("📊 t-SNE saved as tsne_visualization_v1_3th_layer_1.png")
