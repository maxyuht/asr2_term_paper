...
if __name__ == "__main__":
    # ✅ 数据加载
    train_set = FeatureEmotionDataset("./splits_v3_6th_layer/train")
    val_set = FeatureEmotionDataset("./splits_v3_6th_layer/val")
    ...
    os.makedirs("./models_v3_6th_layer", exist_ok=True)
    log_file = open("train_log_v3_6th_layer.txt", "w")
    ...
    for epoch in range(30):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "./models_v3_6th_layer/best_model_v3_6th_layer.pt")
    ...
    log_file.close()
    torch.save(model.state_dict(), "./models_v3_6th_layer/classifier_v3_6th_layer.pt")
    ...
    plt.tight_layout()
    plt.savefig("training_curve_v3_6th_layer.png")
    plt.show()
    ...
    with open("val_classification_report_v3_6th_layer.txt", "w") as f:
    ...
    plt.grid(False)
    plt.savefig("val_confusion_matrix_v3_6th_layer.png")
    plt.show()
