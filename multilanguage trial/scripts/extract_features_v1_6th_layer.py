...
#  路径设置
data_dir = "./data_v1"
save_dir = "./features_v1_6th_layer"
...
print(" All features have saved to ./features_v1_6th_layer/\n")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("tsne_visualization_v1_6th_layer.png")
plt.show()

print(" t-SNE saving as tsne_visualization_v1_6th_layer.png ")
